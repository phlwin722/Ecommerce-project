            ...
            <nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark" style="display:block;">
              <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <form class="d-flex" role="search" action="" method="post" style="margin-right: 100px;">
                    <input class="form-control me-2 search_input" type="search" placeholder="Search" aria-label="Search" name="search_data">
         ...
         <!--about us--> 
            ...
            try {
              ...
              if(isset($_POST['search_data_product'])){
                  ...
                  // Prepare and execute a query with search term
                  $query = "SELECT * FROM product_list WHERE Product_name LIKE :search_term";
                  $statement = $pdo->prepare($query);
                  $statement->bindValue(':search_term', '%' . $search_term . '%');
                  $statement->execute();
          
                  // Fetch all data matching the search term
          ...
          ?>
                         <div class="col-md-3" id="cem">
                              <div class="card" style="width: 18rem; padding:10px; height:420px;">
                                  <img src="/shopping-cart-oche/Project/admin/product/product_image_list/<?php echo $row['Image']; ?>" width="100" height="150" alt="<?php echo $row['Product_name']; ?>" class="card-img-top" width="150" height="170">  
                                  <div class="card-body" style="postion:relative;">
                                      <h6 style="font-weight:bold;"><?php echo $row['Product_name']; ?></h6>
          ...
          <?php
                      ...
                      echo ' <div class="col-md-12" id="cem">
                               <p style="font-size:30px; color:red; padding-top:20px;">No results found!</p>
                            </div>';
                  }
              }
