...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/shopping-cart-oche/Project/user_login/health_beuty/health_beutyy.css">
           <!--Favicon-->
           <link rel="icon" type="image/x-icon" href = "/shopping-cart-oche/Project/Image/logo.png">
  
        <title>Health & Beauty Product</title>
    </head>
    <?php 
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <script>
              ...
              function fetchData() {
                  ...
                  xhr.open("GET", "health_beuty_fetch.php", true);
                  xhr.send();
              }
