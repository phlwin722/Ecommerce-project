...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/shopping-cart-oche/Project/admin/dashboard/dashboardd.css">
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
          ...
          <div class="container text-center" style="border: 1px ; max-width: 100%; padding: 0px;">
                    ...
                    <div class="col text-start table_content"  style=" background-color: rgba(236, 236, 236, 0.966); padding:0px 10px 10px 10px;">
                      ...
                      <label class="text-start " style="font-weight: bold; font-size: 20px; margin-top: 10px;"> Dashboard</label>
                          <br>
                          <br>            
