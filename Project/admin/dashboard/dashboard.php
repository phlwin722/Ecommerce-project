<?php
//this to check if have session or not
  session_start();
    ...
    <body>
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
              ...
              <a class="navbar-brand" href="#"><img src="/shopping-cart-oche/Project/Image/logo.png" height="30" width="60"> </a>
          ...
          <div class="container text-center" style="border: 1px solid black; max-width: 100%;">
                     <div class="row">
                        <div class="col-md-auto" id="wid" style="border: 1px solid black;">
