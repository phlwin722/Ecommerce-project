          ...
          <div class="container text-center" style=" max-width: 100%; padding: 0px;  background-color: rgba(224, 223, 221, 0.966);">
                     <div class="row" id="row" style="padding: 0px;">
                        ...
                        <hr style="color: white;">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" style="color: white;" href="/shopping-cart-oche/Project/Message/Message.php">  <i class="fa-solid fa-message" style="margin-right:10px;"></i>
                              Message
                          </a>
                          </li>
                          <li class="nav-item">
                    ...
                    <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" style="padding:10px 20px 10px 20px; " aria-labelledby="offcanvasDarkNavbarLabel">
                        ...
                        <hr style="color: white;">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" style="color: white;" href="/shopping-cart-oche/Project/Message/Message_user.php">  <i class="fa-solid fa-message" style="margin-right:10px;"></i>
                              Message
                          </a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" style="color: white;" href="/shopping-cart-oche/Project/Feedback/feedback.php">  <i class="fa-solid fa-comment" style="margin-right:10px;"></i>
                              Feedback
                          </a>
                          </li>
                          <li class="nav-item">
                        ...
                        <div class="col-md-auto"  id="grid_size" style=" background-color: rgba(224, 223, 221, 0.966); padding-top: 2vh;">
                          <div class="co" >
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="container" style="text-align: left;">
                                  <div class="row" style="">
                                    ...
                                    <div class="col">
                                      ...
                                      <input type="text" class="form-control" id="validationDefault02" value="Mark" required>
                                    
                                    </div>
                                    <div class="col">
                                      <label for="validationDefault03" class="form-label">Middle name</label>
                                      <input type="text" class="form-control" id="validationDefault03" value="Mark" required>
                                  ...
                                  <div class="row" style="margin-top: 20px;">
                                    ...
                                    <div class="col">
                                      ...
                                      <input type="text" class="form-control" id="validationDefault05" value="Mark" required>
                                    </div>
                                    <div class="col">
                              ...
                              <div class="container"> 
                                 <img src="/Project/Image/back-img-capha.jpg" class="img-thumbnail rounded text-start" alt="...">   
                                  <br>  
