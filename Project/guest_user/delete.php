...
<html>
    ...
    <body>
      ...
      <!-- 
      <div class="col-md-3 ">
        <nav class="nav flex-column choose">
          <a class=" fon active" aria-current="page" href="#">Electronic Devices</a>
          <a class=" fon" href="#">Electronic Accessories</a>
          <a class="fon" href="#">Tv & Home Appliances</a>
          <a class=" fon" href="#">Health & Beauty</a>
          <a class=" fon" href="#">Babies & Toys</a>
          <a class="fon" href="#">Grocerise & Pet</a>
          <a class=" fon" href="#">Home & Living</a>
          <a class=" fon" href="#">Women's Fassion & Accessories</a>
          <a class="fon" href="#">Men's Fassion & Accessories</a>
          <a class="fon" href="#">Sports & Lifestyle</a>
          <a class="fon" href="#">Automotive & Motorcycle</a>
        </nav>
  </div>
  -->
