...
if (isset($_POST['form1'])) {
    ...
    $success_message = "Shipping Information is updated successfully";
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cust_s_country" class="form-control">
                                        ...
                                        foreach ($result as $row) {
                                            ?>
                                            <option value="<?php echo $row['prov_id']; ?>" <?php if($row['prov_id'] == $_SESSION['customer']['cust_s_country']) {echo 'selected';} ?>><?php echo $row['prov_name']; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
