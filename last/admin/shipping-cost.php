...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        $statement = $pdo->prepare("INSERT INTO tbl_shipping_cost (prov_id,amount) VALUES (?,?)");
        $statement->execute(array($_POST['prov_id'],$_POST['amount']));
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Shipping cost for rest of the city is updated successfully.';
                ...
                <div class="box box-info">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select name="prov_id" class="form-control select2">
                                    ...
                                    foreach ($result as $row) {
                                        ...
                                        $statement = $pdo->prepare("SELECT * FROM tbl_shipping_cost WHERE prov_id=?");
                                        $statement->execute(array($row['prov_id']));
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
          ...
          <table id="example1" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
            	...
            	$statement = $pdo->prepare("SELECT * 
                                        ...
                                        JOIN tbl_province t2 
                                        ON t1.prov_id = t2.prov_id 
                                        ORDER BY t2.prov_name ASC");
            	$statement->execute();
            	$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
            	foreach ($result as $row) {
            		$i++;
      ...
      <h4 style="background: #dd4b39;color:#fff;padding:10px 20px;">NB: If a City does not exist in the above list, the following  shipping cost will be applied upon that.</h4>
...
<section class="content-header">
    <div class="content-header-left">
        <h1>Shipping Cost (out of the range)</h1>
    </div>
</section>
