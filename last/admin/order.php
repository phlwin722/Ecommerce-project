...
Card Year: '.$row['card_year'].'<br>
        		';
        	elseif($row['payment_method'] == 'G-cash'):
				$payment_details = '
...
';
        ...
        ini_set($to_customer, $subject_text);
            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <td>
                        	<?php if($row['payment_method'] == 'G-cash'): ?>
                        		...
                        		<b>Refefrence number:</b> <?php echo $row['bank_transaction_info']; ?><br>
