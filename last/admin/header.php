	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">R.E Flores Printing Services</span>
			</a>
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
					...
					<li class="treeview <?php if( ($cur_page == 'admin_interface.php') ) {echo 'active';} ?>">
			          <a href="admin_interface.php">
					  <i class="fa fa-pencil" aria-hidden="true"></i> <span>Design</span>
			          </a>
			        </li>
					<li class="treeview <?php if( ($cur_page == 'set_ship_date.php') ) {echo 'active';} ?>">
			          <a href="set_ship_date.php">
					  <i class="fa fa-pencil" aria-hidden="true"></i> <span>Schedule of Release Design</span>
			          </a>
			        </li>
