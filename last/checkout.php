	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12 form-group">
	                                    ...
	                                    <select name="payment_method" class="form-control select2" id="advFieldsStatus">
	                                        ...
	                                        <option value="Bank Deposit"><?php echo "Gcash"; ?></option>
	                                    </select>
	                                </div>
                                    ...
                                    <form action="payment/bank/init.php" method="post" id="bank_form">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <label for=""><?php echo "Send to this Gcash number"; ?></span></label><br>
                                            <?php
                                            $statement = $pdo->prepare("SELECT * FROM tbl_settings WHERE id=1");
                                            $statement->execute();
                                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                        ...
                                        <div class="col-md-12 form-group">
                                            <label for=""><?php echo "GcashReference Number:"; ?> <br><span style="font-size:12px;font-weight:normal;">(<?php echo "After you pay send us Click contact us and send your own design base on your product you choice for clear photo"; ?>)</span></label>
