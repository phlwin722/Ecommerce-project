					...
					<div class="row">
						...
						<div class="col-md-7">
							...
							<div class="btn-cart btn-cart1">
                                <input type="submit" value="<?php echo "Design Your own "; ?>" name="form_add_to_cart">
							</div>
                            </form>
							<div class="share">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    ...
                    <h3><?php echo "See all related products from below"; ?></h3>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <h4>
                                    <?php echo "Currency"; ?><?php echo $row['p_current_price']; ?> 
                                    <?php if($row['p_old_price'] != ''): ?>
                                    <del>
                                        <?php echo "Currency"; ?><?php echo $row['p_old_price']; ?>
                                    </del>
                                    <?php endif; ?>
                                </h4>
                                <div class="rating">
